#!/usr/bin/env python3
"""Export batch 14: remaining Latin gaps + guillemet glossary terms not in top50."""
...
OUT = Path(__file__).parent / "_batch14_candidates.json"
KEYS_OUT = Path(__file__).parent / "_batch14_keys.json"
