#!/usr/bin/env python3
"""Export batch 16: remaining Latin gaps + guillemet glossary terms not in top50."""
...
OUT = Path(__file__).parent / "_batch16_candidates.json"
KEYS_OUT = Path(__file__).parent / "_batch16_keys.json"
