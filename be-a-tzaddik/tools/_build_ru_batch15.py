#!/usr/bin/env python3
"""Build _ru_top50_batch15_data.py from _ru_batch15_manual.json."""
...
MANUAL_JSON = Path(__file__).parent / "_ru_batch15_manual.json"
OUT = Path(__file__).parent / "_ru_top50_batch15_data.py"
KEYS_PATH = Path(__file__).parent / "_batch15_keys.json"


def main() -> None:
    gen = Path(__file__).parent / "_gen_batch15_manual_json.py"
