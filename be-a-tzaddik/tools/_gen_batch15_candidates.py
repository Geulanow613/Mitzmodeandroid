#!/usr/bin/env python3
"""Export batch 15: remaining Latin gaps + guillemet glossary terms not in top50."""
...
OUT = Path(__file__).parent / "_batch15_candidates.json"
KEYS_OUT = Path(__file__).parent / "_batch15_keys.json"
