#!/usr/bin/env python3
"""Build _ru_top50_batch14_data.py from _ru_batch14_manual.json."""
...
MANUAL_JSON = Path(__file__).parent / "_ru_batch14_manual.json"
OUT = Path(__file__).parent / "_ru_top50_batch14_data.py"
...
def main() -> None:
    ...
    lines = [
        '"""Batch 14: Latin gaps + guillemet glossary — explicit mappings."""',
        "",
        "from __future__ import annotations",
        "",
        "TOP50_BATCH14: dict[str, str] = {",
    ]
    for k in keys:
