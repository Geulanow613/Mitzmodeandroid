#!/usr/bin/env python3
"""Export batch 19: remaining RU Latin gaps not yet in ru_deep_fixes."""
...
OUT = Path(__file__).parent / "_batch19_candidates.json"
KEYS_OUT = Path(__file__).parent / "_batch19_keys.json"
