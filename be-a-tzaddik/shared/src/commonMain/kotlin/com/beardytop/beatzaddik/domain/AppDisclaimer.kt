...
object AppDisclaimer {
    ...
    const val STARTUP_BODY =
        "This app is a learning companion, not a rabbi — it does not give halachic rulings, but we try to provide accurate information.\n\n" +
            ...
            "The Pray tab has an in-app weekday siddur — Shacharit, Mincha, Maariv, Musaf when the day calls for it, " +
            "plus food blessings, Birkat Hamazon, and other everyday brachot. A physical siddur is still recommended " +
            "for Shabbat and festivals (and a machzor for Rosh Hashana and Yom Kippur), and because people may give you " +
            "weird looks if you daven from a phone — we know from experience. You can order a quality book from any " +
            "Jewish bookstore; many Jewish texts (including the Chumash) are also free online.\n\n" +
