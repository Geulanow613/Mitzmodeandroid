...
object ChecklistZmanEvaluator {
    ...
    /** L'Dovid with morning prayers — dawn through chatzos (placement per siddur / congregation). */
    private fun ldovidShacharitWindow(now: Long, z: ZmanimSnapshot, tz: String): ItemZmanStatus {
        ...
        return windowStatus(
            now, start, end,
            upcoming = "L'Dovid (Psalm 27) — insert according to your siddur / congregation.",
            ...
            activeHint = "Insert according to your siddur / congregation.",
        )
    }
    ...
    private fun birkatKohanimWindow(
        ...
        return windowStatus(
            now, start, end,
            upcoming = "Birkat Kohanim — available after dawn.",
            upcomingTemplate = "Birkat Kohanim — available after dawn ({time}).",
            upcomingArgs = mapOf(
                "time" to (ZmanimFormatter.formatAfter(start, tz) ?: "after dawn"),
            ),
            ...
            activeHint = if (onPublicFast) {
                "Public fast day: also often at Mincha — until sunset."
            } else {
                null
            },
        )
