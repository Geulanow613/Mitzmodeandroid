...
object MeinShaloshTextEngine {
    ...
    private fun buildHebrew(selection: MeinShaloshSelection): String {
        ...
        return buildString {
            append("בָּרוּךְ אַתָּה ה' אֱלֹהֵינוּ מֶלֶךְ הָעוֹלָם ")
            append(foodOpening)
            ...
            append("רַחֵם ה' אֱלֹהֵינוּ עַל יִשְׂרָאֵל עַמֶּךָ וְעַל יְרוּשָׁלַיִם עִירֶךָ וְעַל צִיּוֹן מִשְׁכַּן כְּבוֹדֶךָ וְעַל מִזְבְּחֶךָ וְעַל הֵיכָלֶךָ. ")
