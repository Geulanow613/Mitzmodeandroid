...
object HalachicTermsDictionary {
    ...
    private val supplemental: List<HalachicTerm> = listOf(
        ...
        line("Asara B'Tevet — minor fast on 10 Tevet from dawn until nightfall; the only fast never postponed when it falls on Friday — break after Friday night Kiddush"),
        ...
        line("candle lighting — Shabbat candles before sunset; weekday Erev Yom Tov before sunset; Motzei Shabbat Yom Tov at tzeit from a pre-existing flame"),
        ...
        line("tallit katan — small four-cornered garment with tzitzit, worn generally over or under the shirt per community custom"),
        ...
        line("kneidlach — matzah balls; those who observe the stringency of not eating gebrochts do not eat kneidlach on Pesach"),
