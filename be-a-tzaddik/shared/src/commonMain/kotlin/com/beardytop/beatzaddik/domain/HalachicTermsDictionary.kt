...
object HalachicTermsDictionary {
    ...
    private val supplemental: List<HalachicTerm> = listOf(
        ...
        line("Motzei Shabbat — Saturday night after Shabbat ends", AKA "Motzash"),
        ...
        line("Rosh Hashana — Jewish New Year (Days of Awe begin)"),
        ...
        line("netilat yadayim — ritual handwashing before bread and after waking"),
        ...
        line("Yaknehaz — wine, kiddush, candle, havdalah blessing, shehecheyanu when Shabbat ends and Yom Tov starts"),
        ...
        line("Mishnah Berurah — detailed commentary on Orach Chaim"),
        ...
        line("Erev — the day before a holy day (Erev Shabbat, Erev Pesach, etc.)"),
        line("Tzeit — halachic nightfall"),
        line("Rav — rabbi; your halachic authority", "rabbi"),
        ...
        line("Seder — Pesach night ritual meal"),
        line("Megillah — Esther scroll on Purim"),
        line("Seudah — festive meal"),
        line("kisui rosh — married women's hair covering (mitzvah for many communities)"),
        ...
        line("hafrashat challah — separating a portion of dough when baking bread; a reminder of the Temple offering", "challah"),
        ...
        line("Borei Pri HaGafen — blessing on wine and grape juice"),
        ...
        line("Chol HaMoed — intermediate festival days between Yom Tov and Shabbat"),
        line("Yom Tov — biblical festival with work rules distinct from Shabbat"),
        ...
        line("Chabad — Chasidic movement following the Lubavitcher Rebbe's teachings"),
        line("rav — rabbi; your halachic authority for personal questions", "rabbi"),
        ...
        line("Mishnah Berurah — detailed commentary on daily halacha in Orach Chaim"),
        ...
        line("Fast of Gedaliah — fast day after Rosh Hashana"),
        line("Asara B'Tevet — fast on 10 Tevet"),
        line("Taanit — a public or personal fast day"),
        ...
        line("chamar medina — significant local beverage some use for festival joy"),
        ...
        line("Hadlakat Nerot — lighting Shabbat or Yom Tov candles before the day begins"),
        ...
        line("Mishnah Berurah — detailed commentary on daily halacha"),
        ...
        line("Pesukei d'Zimra — psalms and praises before morning Shema"),
        line("zimun — invitation to bentch when three or more ate bread together"),
        ...
        line("yad soledet bo — heat hot enough to scald; cooking threshold on Shabbat"),
        ...
        line("Shema al HaMitah — bedtime Shema and protective verses"),
    ...
    private val enrichedOverrides: List<HalachicTerm> = listOf(
        ...
        line(
            "Rav — A rav is a rabbi qualified to answer halachic questions for you and your family. Unlike a teacher or speaker, a rav gives psak for your situation — kashrut, Shabbat, niddah, business, and festivals. Building a relationship with one rav avoids conflicting answers and contradictory minhagim.",
            "rav",
            "rabbi",
            "Rabbi",
        ),
    ...
    fun findMatches(
        ...
        for ((label, term) in matchers) {
            ...
            while (start < text.length) {
                ...
                if (isWordBoundary(text, idx, end) && !overlapsAny(idx until end, excludeRanges)) {
                    candidates.add(
                        HalachicTermMatch(
                            start = idx,
                            end = end,
    ...
    private fun isWordBoundary(text: String, start: Int, end: Int): Boolean {
        ...
        return !before.isTermInteriorChar() && !after.isTermInteriorChar()
    }

    private fun Char?.isTermInteriorChar(): Boolean =
        this != null && (isLetterOrDigit() || this == '\'')
    ...
    private fun buildMatchers(terms: List<HalachicTerm>): List<Pair<String, HalachicTerm>> =
        terms
            .flatMap { term -> term.matchLabels.map { label -> label to term } }
