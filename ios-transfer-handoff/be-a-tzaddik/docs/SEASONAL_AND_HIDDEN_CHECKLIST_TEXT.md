...
Titles and explanation text as shown in the app. Dynamic parts (Omer day number, sunset/tzeit times, which Yom Tov–Shabbat blocks appear) depend on your calendar and location.

Explanations are aligned with mainstream Orthodox sources (Peninei Halakha, Chabad.org, Aish, Ohr Somayach / ohr.edu). Where poskim disagree, both views are noted. Ask your rav for personal psak.

**For beginners:** Each explainer in the app starts with a **Key terms** block defining words like *melacha*, *Yom Tov*, *bedikat chametz*, *eruv tavshilin*, *Yaknehaz*, etc. The glossary below matches those blocks.

### Key terms glossary

- **Melacha** — transformative labor forbidden on Shabbat (including cooking). On Yom Tov, ochel nefesh (food prep for that day, from a pre-existing flame) is permitted; writing, new fires, etc. remain restricted
...
- **Tzeit** — halachic nightfall (three medium stars) for night mitzvot like bedikat chametz, Chanukah candles, and counting the Omer. Note: While standard Shabbat and weekday Erev Yom Tov candles must be lit before sunset, whenever a festival begins on Motzei Shabbat, Yom Tov candles must be lit only after tzeit, using a pre-existing flame
...
- **Eruv tavshilin** — symbolic food set before Yom Tov so you may cook on the festival for the Shabbat that follows (certain years only)
- **Blech** — metal cover keeping food warm on Shabbat without cooking
- **Chametz** — leavened grain forbidden on Pesach
- **Bedikat chametz** — formal search for chametz the night before Pesach
- **Biur chametz** — destroying chametz the next morning
- **Mechirat chametz** — selling chametz through your rabbi before Pesach
- **Kol Chamira** — declaration nullifying chametz still in your possession
- **Seder** — Pesach night ritual with Haggadah, matzah, four cups of wine
- **Chol HaMoed** — middle days of Pesach or Sukkot (lighter work rules than full Yom Tov)
- **Revi'it** — ritual liquid volume; ~86 ml (lenient) to ~150 ml (stringent for Torah-level mitzvot like Kiddush and the four cups; confirm with your rav)
- **Chamar medina** — significant local drink some use instead of wine for festival joy (kosher-for-Passover liquor or coffee on Pesach — never beer)
- **Simchat Yom Tov** — rejoicing on the festival (wine, food, enjoyment)
- **Daven / davening** — pray; structured services (Shacharit, Mincha, Maariv)
- **Amidah / Shmoneh Esrei** — central standing prayer
- **Musaf** — extra Amidah on Shabbat, Yom Tov, and Rosh Chodesh
- **Hallel** — psalms of praise on festivals and Rosh Chodesh
- **Yaaleh V'yavo** — paragraph added to Amidah and bentching on Rosh Chodesh and festivals
- **Megillah / matanot la'evyonim / mishloach manot** — Purim: hear Esther scroll; one gift to each of two different poor people; two foods to one friend on Purim day
- **Sefirat HaOmer** — counting 49 days from Pesach to Shavuot
- **Minhag** — community or family custom
- **Rav** — your rabbi for personal halachic questions

### Table of contents (holiday prep & seasonal items)

1. [When the checklist is hidden](#when-the-checklist-is-hidden)
2. [Friday only (Erev Shabbat)](#friday-only-erev-shabbat)
3. [Sefirat HaOmer](#sefirat-haomer)
4. [Chanukah](#chanukah)
5. [Purim](#purim)
6. [Erev Yom Tov (chag)](#erev-yom-tov-chag) — includes Simchas Yom Tov block for regalim
7. [Tomorrow: Holiday & Shabbat — prepare today](#tomorrow-holiday--shabbat--prepare-today)
8. [Yom Tov meeting Shabbat](#yom-tov-meeting-shabbat-extra-paragraphs)
9. [Prepare for the festival](#prepare-for-the-festival-week-before-pesach-shavuot-sukkot) — Pesach, Shavuot, Sukkot week-before
10. [Pesach (Erev Pesach items)](#pesach-erev-pesach-items) — mechirat, taanit, seder, bedikat, biur
11. [Rosh Chodesh](#rosh-chodesh)
12. [Kiddush Levana](#kiddush-levana)
13. [Chol HaMoed](#chol-hamoed)
14. [Sukkot](#sukkot) — sukkah build, arba minim, Shemini Atzeret, Simchat Torah
15. [Mourning periods](#mourning-periods)
16. [Selichot (Elul)](#selichot-elul)
17. [Tu B'Shvat](#tu-bshvat)
18. [Israeli national days](#israeli-national-days)
