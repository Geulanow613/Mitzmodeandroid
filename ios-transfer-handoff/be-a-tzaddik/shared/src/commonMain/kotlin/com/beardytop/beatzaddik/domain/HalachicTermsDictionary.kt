...
object HalachicTermsDictionary {
    ...
    private val supplemental: List<HalachicTerm> = listOf(
        ...
        line("Simchat Torah — rejoicing with the Torah; in Israel celebrated on the same day as Shemini Atzeret; the second day of the Shemini Atzeret Yom Tov in the Diaspora"),
        ...
        line("Lag BaOmer — 33rd day of the Omer; mourning eased in many communities. Ashkenaz often ends the first-33 mourning window when Lag begins; Sephardi custom commonly keeps restrictions through Lag itself. Chabad / Arizal: Lag is a one-day suspension (celebration and music permitted; mourning returns on day 34) until Erev Shavuot — many still keep adult haircuts stricter than the Lag break, with upsherin (a 3-year-old boy's first haircut) a common Lag exception; ask your rav"),
        ...
        line("Half Hallel — shortened Hallel psalms on Rosh Chodesh and on Chol HaMoed / the later days of Pesach (not on the opening Yom Tov day(s))"),
        line("Full Hallel — complete Hallel psalms (113–118) on Yom Tov days, all eight days of Chanukah, and the first day of Pesach in Israel (first two days in the Diaspora)"),
        ...
        line("Borei Minei Besamim — catch-all blessing on fragrant herbs, spices, flowers, fruit, etc. (often said as the spice blessing in Havdalah after Shabbat, though some will say a more specific blessing on pleasant fragrances)"),
        line("Gam zu l'tovah — this too is for the good; trust that hardship can be for the greater good"),
        line("Nachum Ish Gamzu — sage known for finding good in every situation"),
        line("honoring your parents — Kibud Av V'Eim - mitzvah to honor/respect and care for parents"),
        ...
        line("hechsher — in kashrut, a certification that food was produced under reliable kosher supervision"),
        line("fleishig — meat status; dairy may not be eaten for a waiting period afterward, usually 6 hours"),
        line("milchig — dairy status"),
        line("pareve — neutral foods (neither meat nor dairy) such as fish, eggs, and produce"),
        line("gematria — numerical value of Hebrew letters"),
        ...
        line("siyum — completion of a Torah text such as a tractate of the Talmud, often with a festive meal"),
        ...
        line("Shomer Daltot Yisrael — Guardian of the doors of Israel (acronym Shin-Dalet-Yod (one of Hashem's names) on mezuzah)"),
        ...
        line("teruah — quick staccato shofar blasts"),
        line("kneidlach — matzah balls; those who observe the stringency of not eating gebrochts do not eat kneidlach on Pesach until the 8th day in the diaspora"),
        line("shinui — unusual change of method that sometimes permits melacha leniency"),
        line("Mavir — creating a new flame; forbidden on Shabbat and Yom Tov; transferring an existing flame is permitted on Yom Tov"),
        line("17 Tammuz — fast marking breaching of Jerusalem's walls"),
        line("ketubah — marriage contract outlining husband's obligations"),
        line("Shabbos — Shabbat"),
        ...
        line("Chasidim — a group of Jews who follow a movement that emphasizes deep mystical devotion, joyful worship, and a close-knit community led by a spiritual leader known as a Rebbe."),
        line("gemilut chasadim — acts of loving-kindness"),
    ...
    private val enrichedOverrides: List<HalachicTerm> = listOf(
        ...
        line(
            "hafrashat challah — Hafrashat challah is separating a small portion of dough when baking a large amount of bread or similar flour-based foods, then burning or discarding in many customs. It recalls the Temple-era gift to the kohen (when they were in a state of ritual purity and able to eat it).",
            "hafrashat challah",
        ),
        line(
        ...
        line(
            "Hallel — Hallel is a set of psalms (113–118, with variations) praising G-d for salvation. Full Hallel is recited on major festivals, all eight days of Chanukah, and the opening of Pesach (1 day in Israel; both first Diaspora Yom Tov days outside Israel). Half Hallel (Partial Hallel) is said on Rosh Chodesh and the later days of Pesach (Chol HaMoed and the final Yom Tov days). Hallel is not recited on Rosh Hashana or Yom Kippur (Arachin 10b). It is said standing, with joy.",
            "hallel",
            "Hallel",
            "Half Hallel",
            "Full Hallel",
        ...
        line(
            "Musaf — Musaf is the \"additional\" Amidah remembering the extra Temple offerings (musaf offerings) brought on Shabbat, Rosh Chodesh, Yom Tov, and Chol HaMoed. Its central blessing describes what was offered and prays for the Temple's restoration. Without the Temple, prayer replaces sacrifice — Musaf is how we still connect to that service.",
            "musaf",
            "Musaf",
        ),
        line(
        ...
        line(
            "Mincha — Mincha is the afternoon service, ideally before sunset. On weekdays it is short; on Shabbat and Yom Tov it often includes a Torah reading. Musaf is a separate morning Amidah on Shabbat, Rosh Chodesh, and festivals — not part of Mincha. Friday Mincha is special — it enters Shabbat. Missing Mincha requires tashlumin at Maariv when possible. Working people often pray Mincha at shul or a quiet office corner.",
            "Mincha",
            "mincha",
        ),
        line(
