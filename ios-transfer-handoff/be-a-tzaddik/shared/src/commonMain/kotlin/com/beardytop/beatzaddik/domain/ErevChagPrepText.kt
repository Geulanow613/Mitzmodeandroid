...
• Hachana / meechin (no prep across days): do not do physical tasks on Day 1 for Day 2 or for after the festival — meal prep, washing plates, table setup for tomorrow, and similar. Prep for the next night waits until tzeit hakochavim. If you cook a pot intending to eat some today, cooking extra in that same pot is fine; do not make extra effort or say it is for tomorrow. When Shabbat falls directly before Yom Tov, no eruv tavshilin — wait until Shabbat ends before any holiday prep.
